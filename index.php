...
<head>
  ...
  <title>Crowncalz Bootstrap Template - Index</title>
    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Bettter Digital Experience With Crowncalz</h1>
          <h2>We are team of talented designers making websites with Bootstrap</h2>
          <div><a href="loancalculator.php" class="btn-get-started scrollto">Get a loan</a></div>
        </div>
    ...
    <div class="container">
      ...
      <div class="copyright-wrap d-md-flex py-4">
        <div class="me-md-auto text-center text-md-start">
          <div class="copyright">
            &copy; Copyright <strong><span>Crowncalz</span></strong>. All Rights Reserved
          </div>
          <div class="credits">
            <!-- All the links in the footer should remain intact. -->
            <!-- You can delete the links only if you purchased the pro version. -->
            <!-- Licensing information: https://Crowncalz.com/license/ -->
            <!-- Purchase the pro version with working PHP/AJAX contact form: https://Crowncalz.com/Crowncalz-free-skin-bootstrap-3/ -->
            Designed by <a href="https://Crowncalz.com/">Crowncalz</a>
          </div>
        </div>
